      ...
      <div className="drawer-side">
        ...
        <aside className="bg-base-200 w-64 h-full flex flex-col">
          <div className="flex items-center justify-center py-4">
            ...
            {/* <Image
              src={ContentLogo} // Imported StaticImageData
              alt="Content Craft Logo" // Descriptive alt text for accessibility
              width={40} // Adjust width to your needs
              height={40} // Adjust height to your needs
              className="w-16 h-18 text-success"
              priority // Ensures logo is loaded immediately
            /> */}
          </div>
